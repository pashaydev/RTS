...
use crate::infrastructure::debug::state::{DebugPanelState, TweakStructureVersion};
...
use crate::infrastructure::debug::ui::style::{
...
fn spawn_toggle_row(parent: &mut ChildSpawnerCommands, folder: &str, label: &str, value: bool) {
    parent
        ...
        .with_children(|row| {
            ...
            let bg = if value {
                crate::infrastructure::debug::ui::style::debug_active_surface()
            } else {
