...
fn register_entity_debug_tweaks(mut tweaks: ResMut<DebugTweaks>) {
    ...
    for field in crate::infrastructure::multiplayer::NET_STAT_FIELDS {
...
fn sync_frustum_debug_tweaks(
    ...
    cullables: Query<
        ...
        Or<(
            ...
            With<crate::types::Mob>,
            With<crate::types::Building>,
            With<crate::types::ResourceNode>,
            With<crate::types::Decoration>,
            With<crate::types::Sapling>,
            With<crate::types::GrowingTree>,
            With<crate::types::GrowingResource>,
            With<crate::types::DecoRevealed>,
        )>,
    >,
) {
    if !state.frustum_culling {
...
fn sync_ai_debug_tweaks(
    ...
    for (prefix, faction) in rows {
        let configured = crate::simulation::ai::types::faction_uses_ai(&game_config, faction);
...
fn sync_network_debug_tweaks(
    ...
    let tap_api = crate::infrastructure::multiplayer::debug_tap::http_addr()
