...
pub struct IconAssets {
    ...
    pub outpost: Handle<Image>,
    pub gatehouse: Handle<Image>,
    pub guard_tower: Handle<Image>,
    pub ballista_tower: Handle<Image>,
    pub bombard_tower: Handle<Image>,
    pub mine: Handle<Image>,
    pub oil_rig: Handle<Image>,
    // Units
...
impl IconAssets {
    ...
    pub fn entity_icon(&self, kind: EntityKind) -> Handle<Image> {
        match kind {
            ...
            EntityKind::GuardTower => self.guard_tower.clone(),
            EntityKind::BallistaTower => self.ballista_tower.clone(),
            EntityKind::BombardTower => self.bombard_tower.clone(),
            EntityKind::Outpost => self.outpost.clone(),
            EntityKind::Gatehouse => self.gatehouse.clone(),
            EntityKind::WallSegment => self.wall.clone(),
            EntityKind::WallPost => self.wall.clone(),
            EntityKind::WallCorner => self.wall.clone(),
            EntityKind::Floor => self.floor.clone(),
            EntityKind::Storage => self.storage.clone(),
            EntityKind::House => self.house.clone(),
            // Units
            ...
            EntityKind::Sawmill => self.sawmill.clone(),
            EntityKind::Mine => self.mine.clone(),
            EntityKind::OilRig => self.oil_rig.clone(),
            // Production chain buildings
