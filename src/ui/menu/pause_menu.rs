    ...
    for event in click_events.read() {
        ...
        match btn.0 {
            ...
            PauseAction::LoadGame => {
                ...
                commands.insert_resource(crate::ui::menu::MenuPage::LoadGame);
                next_state.set(AppState::MainMenu);
            }
        }
    }
...
fn broadcast_host_shutdown(
    ...
    crate::infrastructure::multiplayer::matchbox_transport::broadcast_reliable(socket, &msg);
}
...
fn cleanup_game_world(
    ...
    // Grass
    commands.insert_resource(GrassRebuildState::default());
