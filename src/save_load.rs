...
pub fn load_saved_game(
    ...
    let footprint = crate::buildings::footprint_for_kind(EntityKind::Floor);
...
fn restore_ai_brain(saved: &SavedAiBrain, id_map: &HashMap<u32, Entity>) -> AiFactionBrain {
    ...
    AiFactionBrain {
        ...
        personality: match saved.personality {
            1 => crate::components::AiPersonality::Aggressive,
            2 => crate::components::AiPersonality::Defensive,
            3 => crate::components::AiPersonality::Economic,
            4 => crate::components::AiPersonality::Supportive,
            _ => crate::components::AiPersonality::Balanced,
        },
